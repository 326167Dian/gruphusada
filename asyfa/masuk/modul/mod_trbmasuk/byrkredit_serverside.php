...
if ($_GET['action'] == "table_data") {
    ...
    if (!empty($query)) {
        ...
        while ($value = $query->fetch_array()) {
            $link = ($r['jatuhtempo']=="")?"?module=byrkredit&act=ubah&id=$value[id_trbmasuk]":"?module=byrkreditpbf&act=ubah&id=$value[id_trbmasuk]";
            // for column
            $nestedData['no'] = $no;
        ...
        //     $nestedData['aksi'] = " <a href=$link title='EDIT' class='btn btn-warning btn-xs'>EDIT</a> 
								//     <a href='?module=trbmasukpbf&act=ubah&id=$value[id_trbmasuk]' title='EDIT' class='btn btn-primary btn-xs'>EDIT PBF</a>
            ...
            $nestedData['aksi'] = " <button type='button' id='btn_edit' data-url='$link' title='EDIT' class='btn btn-warning btn-xs'>EDIT</button> 
								    <button type='button' id='btn_pbf' data-id='$value[id_trbmasuk]' title='EDIT' class='btn btn-primary btn-xs'>EDIT PBF</button>
