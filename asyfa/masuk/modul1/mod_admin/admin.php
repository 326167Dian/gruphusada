	...
	switch ($_GET['act']) {
		...
		default:
			if ($_SESSION['leveluser'] == 'admin') {
				$tampil_admin = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM admin where id_admin !=2 ORDER BY username");
?>
				...
				<div class='box-body'>
						<form method=POST action='$aksi?module=admin&act=input_admin' class='form-horizontal'>
							  ...
							  <div class='form-group'>
							   ...
							   <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Inventory</label>        		
									 <div class='col-sm-4'>
		...
		case "editadmin":
		  ...
		  <div class='box box-primary box-solid'>
			...
			echo "> Kartu Stok</br>
                                        ...
                                        <input type=checkbox name='catatan[]' value='Y' ";
			if ($r['catatan'] == "Y") {
				echo "checked";
			}
			echo "> Catatan</br>
