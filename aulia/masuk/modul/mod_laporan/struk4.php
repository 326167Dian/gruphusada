...
$pdf->Line(0.8, 4.5, 6.5, 4.5); //judul tabel atas
...
$pdf->SetX(0.8);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(2.2, 0.5, 'Item', 0, 0, 'L');
$pdf->Cell(0.8, 0.5, 'Qty', 0, 0, 'R');
$pdf->Cell(0.8, 0.5, 'sat', 0, 0, 'R');
...
while ($r2 = mysqli_fetch_array($query)) {
	...
	$pdf->Cell(2.2, 0.4, $r2['kd_barang'], 0, 0, 'L');
	$pdf->Cell(0.8, 0.4, $r2['qty_dtrkasir'], 0, 0, 'R');
	$pdf->Cell(0.8, 0.4, $r2['sat_dtrkasir'], 0, 0, 'C');
