...
switch($_GET['act']){
  ...
  default:
      ...
      $tampil_komisi = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM barang WHERE komisi != 0 ORDER BY id_barang DESC");
	  ...
	  ?>
         ...
         <!--                           <a href="?module=komisi&act=editkomisi&id=<?=$r['id_barang']?>" title="EDIT" class="glyphicon glyphicon-pencil">&nbsp</a> -->
									...
									<button type='button' class='btn btn-warning btn-xs' id='btn_edit' data-id='<?=$r['id_barang']?>'>EDIT</button>
        						    <button type='button' class='btn btn-danger btn-xs' id='btn_hapus' data-id='<?=$r['id_barang']?>'>HAPUS</button>
								</td>
                                <?php endif;?>
							</tr>
						    <?php
						...
						<form method="POST" action="<?=$aksi?>?module=komisi&act=input_komisi" enctype="multipart/form-data" class="form-horizontal">
							  ...
							  <div class='form-group'>
									<label class='col-sm-2 control-label'>JUMLAH KOMISI</label>        		
									 <div class='col-sm-6'>
										<input type="text" name="komisi" id="komisi" class="form-control" required="required" autocomplete="off">
									 </div>
							  </div>
...
?>
            ...
            <div class='box box-primary box-solid'>
				...
				<div class='box-body'>
						...
						<form method="POST" action="<?=$aksi?>?module=komisi&act=update_komisi" enctype="multipart/form-data" class="form-horizontal" id="frmEditKomisi">
							  ...
							  <div class='form-group'>
									<label class='col-sm-2 control-label'>Jumlah Komisi</label>        		
									 <div class='col-sm-6'>
										<input type="text" name="komisi" id="komisi" class="form-control" required="required" value="<?=$r['komisi']?>" autocomplete="off">
									 </div>
							  </div>
...
?>
        ...
        <script>
            $(document).ready(function() {
                $("#komisi").mask('000.000.000.000.000', {
                    reverse: true
                });
                ...
                $("#frmEditKomisi").submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        {
                            location.href = '?module=komisi&page='+vpage;
                        }
                    });
