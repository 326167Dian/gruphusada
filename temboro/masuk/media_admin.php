			...
			<div class="wrapper">
				...
				<header class="main-header">
					...
					<a href="#" class="logo">
						...
						<span class="logo-mini"><marquee><b>Apotek Anugrah Sukowinangun Baru</b></marquee></span>

						<!-- logo for regular state and mobile devices -->
						<span class="logo-lg"><marquee><b>Apotek Anugrah Sukowinangun Baru</b></marquee></span>
					</a>
