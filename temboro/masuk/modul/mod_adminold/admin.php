				...
				<div class='box-body'>
						<form method=POST action='$aksi?module=admin&act=input_admin' class='form-horizontal'>
							  ...
							  <div class='form-group'>
							   ...
							   <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Stok & Pengadaan</label>        		
									 <div class='col-sm-4'>
				...
				<div class='box-body'>
				        ...
				        <form method=POST action='$aksi?module=admin&act=update_admin' class='form-horizontal' id='frmEditAdmin'>
							 ...
							 <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Data Master</label>        		
									 <div class='col-sm-4'>
										<input type=checkbox name='mpengguna[]' id='mpengguna' value='Y' ";
			if ($r['mpengguna'] == "Y") {
				echo "checked";
			}
			echo "> Operator </br>
										<input type=checkbox name='mheader[]' id='mheader' value='Y' ";
			if ($r['mheader'] == "Y") {
				echo "checked";
			}
			echo "> Header Struk </br>
										<input type=checkbox name='mjenisbayar[]' id='mjenisbayar' value='Y' ";
			if ($r['mjenisbayar'] == "Y") {
				echo "checked";
			}
			echo "> Jenis Pembayaran </br>
										<input type=checkbox name='mpelanggan[]' value='Y' ";
			if ($r['mpelanggan'] == "Y") {
				echo "checked";
			}
			echo "> Pelanggan </br>
										<input type=checkbox name='msupplier[]' value='Y' ";
			if ($r['msupplier'] == "Y") {
				echo "checked";
			}
			echo "> Supplier </br>
										<input type=checkbox name='mjenisobat[]' value='Y' ";
			if ($r['mjenisobat'] == "Y") {
				echo "checked";
			}
			echo "> Jenis Obat </br>
										<input type=checkbox name='msatuan[]' value='Y' ";
			if ($r['msatuan'] == "Y") {
				echo "checked";
			}
			echo "> Satuan </br>
										<input type=checkbox name='mbarang[]' value='Y' ";
			if ($r['mbarang'] == "Y") {
				echo "checked";
			}
			echo "> Item Barang </br>
			                            <input type=checkbox name='komisi[]' value='Y' ";
			if ($r['komisi'] == "Y") {
				echo "checked";
			}
			echo "> Komisi Pegawai </br>
							  ...
							  <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Stok & Pengadaan</label>        		
									 <div class='col-sm-4'>
										<input type=checkbox name='mstok[]' value='Y' ";
			if ($r['mstok'] == "Y") {
				echo "checked";
			}
			echo "> Nilai Stok Barang </br>
										<input type=checkbox name='stok_kritis[]' value='Y' ";
			if ($r['stok_kritis'] == "Y") {
				echo "checked";
			}
			echo "> Stok Kritis </br>
										<input type=checkbox name='orders[]' value='Y' ";
			if ($r['orders'] == "Y") {
				echo "checked";
			}
			echo "> Pesan Barang </br>
										<input type=checkbox name='stokopname[]' value='Y' ";
			if ($r['stokopname'] == "Y") {
				echo "checked";
			}
			echo "> Stok Opname </br>
										<input type=checkbox name='soharian[]' value='Y' ";
			if ($r['soharian'] == "Y") {
				echo "checked";
			}
			echo "> Stok Opname Harian</br>
										<input type=checkbox name='koreksistok[]' value='Y' ";
			if ($r['koreksistok'] == "Y") {
				echo "checked";
			}
			echo "> Koreksi Stok</br>
										<input type=checkbox name='kartustok[]' value='Y' ";
			if ($r['kartustok'] == "Y") {
				echo "checked";
			}
			echo "> Kartu Stok</br>
							  ...
							  <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Transaksi</label>        		
									 <div class='col-sm-4'>
										<input type=checkbox name='tbm[]' value='Y' ";
			if ($r['tbm'] == "Y") {
				echo "checked";
			}
			echo "> Barang Masuk non PBF </br>
										<input type=checkbox name='tbmpbf[]' value='Y' ";
			if ($r['tbmpbf'] == "Y") {
				echo "checked";
			}
			echo "> Barang Masuk dari PBF </br>
										<input type=checkbox name='byrkredit[]' value='Y' ";
			if ($r['byrkredit'] == "Y") {
				echo "checked";
			}
			echo "> Pembayaran Barang Kredit</br>
										<input type=checkbox name='shiftkerja[]' value='Y' ";
			if ($r['shiftkerja'] == "Y") {
				echo "checked";
			}
			echo "> Buka/Tutup Kasir</br>
										<input type=checkbox name='tpk[]' value='Y' ";
			if ($r['tpk'] == "Y") {
				echo "checked";
			}
			echo "> Penjualan/Kasir </br>
										<input type=checkbox name='penjualansebelum[]' value='Y' ";
			if ($r['penjualansebelum'] == "Y") {
				echo "checked";
			}
			echo "> Penjualan sebelum </br>
									 </div>
							  </div>
							  ...
							  <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Laporan</label>        		
									 <div class='col-sm-4'>
										<input type=checkbox name='lpitem[]' value='Y' ";
			if ($r['lpitem'] == "Y") {
				echo "checked";
			}
			echo "> Laporan Item Barang </br>
										<input type=checkbox name='lpbrgmasuk[]' value='Y' ";
			if ($r['lpbrgmasuk'] == "Y") {
				echo "checked";
			}
			echo "> Laporan Barang Masuk </br>
										<input type=checkbox name='lpkasir[]' value='Y' ";
			if ($r['lpkasir'] == "Y") {
				echo "checked";
			}
			echo "> Laporan Penjualan/Kasir </br>
										<input type=checkbox name='labapenjualan[]' value='Y' ";
			if ($r['labapenjualan'] == "Y") {
				echo "checked";
			}
			echo "> Laporan LABA Penjualan/Kasir </br>
										<input type=checkbox name='labajenisobat[]' value='Y' ";
			if ($r['labajenisobat'] == "Y") {
				echo "checked";
			}
			echo "> Laporan LABA Jenis Obat </br>
										<input type=checkbox name='lpsupplier[]' value='Y' ";
			if ($r['lpsupplier'] == "Y") {
				echo "checked";
			}
			echo "> Laporan Data Supplier </br>
										<input type=checkbox name='lppelanggan[]' value='Y' ";
			if ($r['lppelanggan'] == "Y") {
				echo "checked";
			}
			echo "> Laporan Data Pelanggan </br>
										<input type='checkbox' name='neraca[]' value='Y' ";
			if ($r['neraca'] == "Y") {
				echo "checked";
			}
			echo "> Neraca Laba Rugi </br>
									 </div>
							  </div>
