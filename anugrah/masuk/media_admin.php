			...
			<div class="wrapper">
				...
				<header class="main-header">
					...
					<a href="#" class="logo">
						...
						<span class="logo-mini"><marquee><b>Apotek Anugrah Husada Taufiqurrohman</b></marquee></span>

						<!-- logo for regular state and mobile devices -->
						<span class="logo-lg"><marquee><b>Apotek Anugrah Husada Taufiqurrohman</b></marquee></span>
					</a>
					...
					<section class="sidebar">
						...
						<div class="user-panel">
							...
							<div class="pull-left info">
								<p><?php echo "<marquee>$_SESSION[namalengkap]</marquee>"; ?> </p>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<?php if ($_SESSION['labajenisobat'] == "Y") { ?><li><a href="?module=labajenisobat"><i class='glyphicon glyphicon-print'></i> Laba Jenis Obat </a></li><?php } ?>
